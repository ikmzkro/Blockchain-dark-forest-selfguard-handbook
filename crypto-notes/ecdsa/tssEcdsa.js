...
// // Shamir's Secret Sharing for TSS
...
//             if (xi !== xj) {
//                 const numerator = BigInt(xj);
//                 const denominator = BigInt(xj) - BigInt(xi);
//                 product *= numerator * modInverse(denominator);
//             }
//         }
//         secret += product;
//     }
//     return secret % ec.curve.n;
// }
// // Modular inverse for field operations
// function modInverse(a: bigint, m: bigint = ec.curve.n!): bigint {
